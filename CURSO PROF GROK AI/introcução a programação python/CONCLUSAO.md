...
Dúvidas ou partes que não entendeu 100%: 
[Não tenho dúvidas nesse assunto]

Código final do Exercício 1 (cole o programa completo modificado):
...
Mensagem de erro do Exercício 2:
[Traceback (most recent call last):
  File "c:\Users\marce\OneDrive\Documentos\CURSO PROF GROK AI\introcução a programação python\ex02.py", line 6, in <module>
    print("Idade + 5 (tentativa de cálculo): " + (idade + 5))   # ← isso vai dar ERRO de propósito
                                                  ~~~~~~^~~
TypeError: can only concatenate str (not "int") to str]

Link do repositório GitHub (se já fez push):
